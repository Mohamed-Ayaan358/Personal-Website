          ...
          {displayPosts.map((frontMatter) => {
            ...
            return (
              <li key={slug} className="py-4">
                <article className="space-y-2 rounded-3xl border-2 border-primary-500 bg-cyan-300 py-3 dark:bg-gray-800 xl:grid xl:grid-cols-3 xl:items-baseline xl:space-y-0 ">
                  <dl>
