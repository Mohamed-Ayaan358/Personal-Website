// src/components/MetaballAnimation.js

import React, { useEffect, useRef } from 'react'
import paper, { Point, Path, getAngleInRadians } from 'paper'
...
function MetaballAnimation() {
  ...
  useEffect(() => {
    ...
    // ... (Rest of the code, including the metaball function)
    ...
    return () => {
      // Cleanup Paper.js project when the component unmounts
      paper.project.clear()
    }
  }, [])
